...
function App() {
      ...
      sections.forEach((sec) => {
        ...
        if (top >= offset && top < offset + height) {
          navLinks.forEach((links) => {
            links.className =
              "block py-2 px-3 lg:p-0 text-gray-900 rounded hover:bg-gray-100 lg:hover:bg-transparent lg:hover:text-blue-700 dark:text-white lg:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700";
          });
          document
  ...
  return (
    <div className="bg-white dark:bg-gray-900">
      ...
      <div
        ref={hamburgerBackdropRef}
        id="hamburgerBackdrop"
        className="fixed bottom-0 -left-1 right-0 h-full bg-gray-900/50 dark:bg-gray-900/60 hidden"
        onClick={hamburgerBackdropClick}
      ></div>
