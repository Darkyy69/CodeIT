...
const Produits = () => {
  ...
  const images = [
    ...
    {
      id: "app-web-standard-2",
      src: "https://flowbite.s3.amazonaws.com/docs/gallery/square/image-7.jpg",
    },
    {
      id: "app-web-standard-3",
    ...
    >
      ...
      <div className="flex items-center justify-center py-4 md:py-8 flex-wrap">
        ...
        <button
          type="button"
          id="app-web-custom"
          className={getButtonClass("app-web-custom")}
          onClick={() => filterImages("app-web-custom")}
        >
          App Web Personalisée
        </button>
        <button
          type="button"
          id="app-web-standard"
          className={getButtonClass("app-web-standard")}
          onClick={() => filterImages("app-web-standard")}
        >
          App Web Standarisée
        </button>
        <button
          type="button"
          id="app-mobile"
          className={getButtonClass("app-mobile")}
          onClick={() => filterImages("app-mobile")}
        >
          App Mobile
        </button>
        <button
          type="button"
          id="vitrine-dynamique"
          className={getButtonClass("vitrine-dynamique")}
          onClick={() => filterImages("vitrine-dynamique")}
        >
          Vitrine Dynamique
        </button>
      </div>
      <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
        {images.map((image, index) => (
          <div
            ...
            style={{
              display:
                category === "all" || image.id.includes(category)
                  ? "block"
                  : "none",
            }}
          >
